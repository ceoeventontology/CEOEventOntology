...
parser.add_argument('-s', '--input_sentence', type=str, help="the sentence to predict on", default='')
parser.add_argument('--input_file', type=str, help="the sentence to predict on", default='')
...
if args.input_sentence == '':
    # read the first sentence from the input file
    for line in open(args.input_file):
        args.input_sentence = json.loads(line)['sentence']
        break
